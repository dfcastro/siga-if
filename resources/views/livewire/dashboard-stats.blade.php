<div>
    {{-- Título Dinâmico e seletor de data --}}
    <div class="flex flex-col sm:flex-row justify-between sm:items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800 uppercase tracking-wide flex items-center gap-2">
            ...
            {{-- Aqui usamos $this->isPorteiro de forma super segura --}}
            {{ $this->isPorteiro ? 'Desempenho do Turno' : 'Visão Global da Operação' }}
        </h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
            <h3 class="text-sm font-bold text-gray-500 uppercase tracking-wider mb-6">
                {{ $this->isPorteiro ? 'Meu Fluxo de Acesso por Hora' : 'Fluxo Global de Entradas por Hora' }}
            </h3>
        ...
        <div class="flex flex-col gap-4">
            ...
            {{-- Card de Entradas Particulares (Dinâmico) --}}
            <x-stats-card title="{{ $this->isPorteiro ? 'Minhas Entradas Registradas' : 'Total de Acessos Liberados' }}"
            ...
            {{-- Card de Saídas Oficiais (Dinâmico) --}}
            <x-stats-card title="{{ $this->isPorteiro ? 'Minhas Saídas Autorizadas' : 'Viagens Iniciadas (Oficial)' }}"
                :value="$totalOfficialDeparturesToday" color="blue">
            ...
            {{-- Card do Pátio (Sempre Global) --}}
            <x-stats-card title="Aguardando Saída (No Pátio)" :value="$vehiclesInYard" color="orange">
            ...
            {{-- Card de Frota Oficial (Sempre Global) --}}
            <x-stats-card title="Viaturas Oficiais em Rota" :value="$officialTripsInProgress" color="teal">
