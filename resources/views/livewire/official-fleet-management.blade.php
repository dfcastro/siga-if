                ...
                <div class="overflow-x-auto border border-gray-200 sm:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-100">
                            <tr>
                                <th scope="col"
                                    class="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                    Veículo</th>
                                <th scope="col"
                                    class="px-3 md:px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                                    Condutor</th>
                                ...
                                <th scope="col"
                                    ...
                                    Saída</th>
                                <th scope="col"
                                    class="px-3 md:px-6 py-3 text-center text-xs font-medium text-gray-600 uppercase tracking-wider">
                                    Ações</th>
                            </tr>
                        </thead>
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($ongoingTrips as $trip)
                                <tr>
                                    {{-- NOVO: Informações empilhadas e sem quebra de linha desnecessária --}}
                                    <td class="px-3 md:px-6 py-4 align-middle">
                                    ...
                                    <td class="px-3 md:px-6 py-4 align-middle text-sm text-gray-600">
                                        {{ $trip->driver->name }}</td>
                                    <td class="px-3 md:px-6 py-4 align-middle text-sm text-gray-600">
                                        {{ $trip->destination }}</td>
                                    <td class="px-3 md:px-6 py-4 align-middle text-sm text-gray-600">
                                        <div>{{ $trip->departure_datetime->format('d/m/Y') }}</div>
                                        <div class="text-xs text-gray-500">
                                            {{ $trip->departure_datetime->format('H:i') }}h</div>
                                        <div class="text-sm text-green-600 mt-1">
                                            {{ number_format($trip->departure_odometer, 0, ',', '.') }} km</div>
                                    </td>
                                    <td class="px-3 md:px-6 py-4 align-middle text-center">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($completedTrips as $trip)
                                <tr>
                                    ...
                                    <td class="px-3 md:px-6 py-4 align-middle text-sm text-gray-600">
                                        {{ $trip->driver->name }}</td>
                                    {{-- NOVO: Datas de Saída e Chegada empilhadas em uma única coluna --}}
                                    <td class="px-3 md:px-6 py-4 align-middle text-sm text-gray-600">
                                    ...
                                    <td class="px-3 md:px-6 py-4 align-middle text-sm font-medium text-gray-800">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label for="departure_odometer"
                                    class="block text-sm font-medium text-gray-700">Quilometragem de Saída (km)</label>
