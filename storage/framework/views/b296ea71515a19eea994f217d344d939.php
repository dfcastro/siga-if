...
<?php endif; ?>
        ...
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:hidden">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        class="bg-white border rounded-lg p-4 shadow-sm flex flex-col justify-between <?php echo e($driver->trashed() ? 'bg-red-50/50 opacity-70' : ''); ?> transition duration-150 ease-in-out">
                        <div>
                            <div class="flex justify-between items-start mb-2">
                                <h3 class="font-semibold text-lg text-gray-800 truncate" title="<?php echo e($driver->name); ?>">
                                    <?php echo e($driver->name); ?>

                                </h3>
                                <span
                                    class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($driver->is_authorized ? 'bg-green-100 text-green-800 border border-green-200' : 'bg-red-100 text-red-800 border border-red-200'); ?> ml-2 flex-shrink-0">
                                    <?php echo e($driver->is_authorized ? 'Autorizado' : 'Não Autor.'); ?>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100 flex flex-wrap gap-2 justify-end">
                            <!--[if BLOCK]><![endif]--><?php if($driver->trashed()): ?>
                                <!--[if BLOCK]><![endif]--><?php if($this->canManageDriver($driver)): ?>
                                    ...
                                    <button wire:click="confirmForceDelete(<?php echo e($driver->id); ?>)" type="button"
