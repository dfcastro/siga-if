<div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-3">
    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $months; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $month): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="border rounded-xl p-3 text-center transition-all duration-200 <?php echo e($currentUI['class']); ?>">
            <?php echo $currentUI['icon']; ?>

            <div class="font-bold text-sm uppercase tracking-wider"><?php echo e($month->translatedFormat('M/y')); ?></div>
            <div class="text-[11px] font-semibold mt-0.5 opacity-90"><?php echo e($currentUI['label']); ?></div>
            
            
            <!--[if BLOCK]><![endif]--><?php if($status === 'rejected' && $submission && $submission->observation): ?>
                <div class="mt-2 pt-2 border-t border-red-200 text-[10px] leading-tight text-red-700 line-clamp-2" title="<?php echo e($submission->observation); ?>">
                    💬 <?php echo e($submission->observation); ?>

                </div>
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        </div>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><!--[if ENDBLOCK]><![endif]-->
</div><?php /**PATH C:\Users\daniel.castro\Desktop\Projetos IFNMG\siga-if\resources\views/livewire/partials/status-grid.blade.php ENDPATH**/ ?>