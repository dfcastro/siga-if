...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <div>
                            ...
                            <select wire:model.live="selectedVehicle" id="vehicle"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div>
                            ...
                            <select wire:model.live="selectedDriver" id="driver"
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $this->drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
