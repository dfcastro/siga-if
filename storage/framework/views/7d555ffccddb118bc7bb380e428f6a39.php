        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="p-4 sm:p-6 text-gray-900 flex justify-between items-center">
                    <div>
                        <h3 class="text-lg font-medium text-gray-800">Olá,
                            <?php echo e(explode(' ', trim(Auth::user()->name))[0]); ?>!</h3>
                    ...
                    <div class="text-right">
                        <span
                            ...
                            PERFIL: <?php echo e(Auth::user()->role); ?>

                        </span>
                        <div class="mt-1 text-xs text-gray-400 font-medium"><?php echo e(now()->format('d/m/Y')); ?></div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <?php if(in_array(Auth::user()->role, ['admin', 'fiscal'])): ?>
                    <a href="<?php echo e(route('fiscal.approval')); ?>"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-120493142-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-120493142-1', $__slots ?? [], get_defined_vars());
...
<?php endif; ?>
<?php /**PATH C:\Users\Daniel\Documents\Projetos\siga-if\resources\views/dashboard.blade.php ENDPATH**/ ?>