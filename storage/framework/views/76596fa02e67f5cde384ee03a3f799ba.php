    ...
    <!--[if BLOCK]><![endif]--><?php if($isHistoryModalOpen && $vehicleForHistory): ?>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col">
                                ...
                                <div class="relative mb-8">
                                    ...
                                    <div class="ml-12 p-4 bg-white border rounded-lg shadow-sm">
                                        <div class="flex justify-between items-center">
                                            <p class="font-semibold text-gray-800">Viagem <?php echo e($entry->type); ?></p><span
                ...
                <div class="px-6 py-4 bg-white text-right mt-auto border-t"> <?php if (isset($component)) { $__componentOriginal3b0e04e43cf890250cc4d85cff4d94af = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal3b0e04e43cf890250cc4d85cff4d94af = $attributes; } ?>
