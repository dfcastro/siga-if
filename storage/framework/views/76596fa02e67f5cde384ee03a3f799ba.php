...
<?php endif; ?>
        ...
        <div class="p-6">
            ...
            <div class="md:flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2 rounded-md shadow-sm" role="group">
                    <button wire:click="$set('filter', 'active')" type="button"
                        class="px-4 py-2 text-sm font-medium <?php echo e($filter === 'active' ? 'bg-ifnmg-green text-white ring-1 ring-ifnmg-green' : 'bg-white text-gray-900 hover:bg-gray-50'); ?> border border-gray-200 rounded-l-lg focus:z-10 focus:ring-2 focus:ring-ifnmg-green transition duration-150 ease-in-out">
                        Ativos
                    </button>
                    <button wire:click="$set('filter', 'trashed')" type="button"
                        class="px-4 py-2 text-sm font-medium <?php echo e($filter === 'trashed' ? 'bg-ifnmg-green text-white ring-1 ring-ifnmg-green' : 'bg-white text-gray-900 hover:bg-gray-50'); ?> border-t border-b border-r border-gray-200 rounded-r-md focus:z-10 focus:ring-2 focus:ring-ifnmg-green transition duration-150 ease-in-out">
                        Lixeira
                    </button>
                </div>
            </div>
                ...
                <table class="min-w-full bg-white divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr
                                class="<?php echo e($vehicle->trashed() ? 'bg-red-50/50' : 'odd:bg-white even:bg-gray-50/50'); ?> hover:bg-blue-50/60 transition duration-150 ease-in-out">
                                <td class="px-6 py-4 align-middle text-sm font-medium text-gray-900 font-mono">
                                    <?php echo e($vehicle->license_plate); ?></td>
                                <td class="px-6 py-4 align-middle text-sm text-gray-600 truncate max-w-xs"
                                    title="<?php echo e($vehicle->model); ?>"><?php echo e($vehicle->model); ?></td>
                                <td class="px-6 py-4 align-middle text-sm text-gray-600 capitalize">
                                    <?php echo e($vehicle->color); ?></td>
                                <td class="px-6 py-4 align-middle text-center">
                                    <span
                                        class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($vehicle->type == 'Oficial' ? 'bg-blue-100 text-blue-800 border border-blue-200' : 'bg-green-100 text-green-800 border border-green-200'); ?>">
                                        <?php echo e($vehicle->type); ?>

                                    </span>
                                </td>
                                <td class="px-6 py-4 align-middle text-sm text-gray-600 truncate max-w-xs"
                                    title="<?php echo e($vehicle->driver->name ?? ''); ?>">
                                    <?php echo e($vehicle->driver->name ?? ($vehicle->type == 'Oficial' ? '-' : 'N/A')); ?>
                                ...
                                <td class="px-6 py-4 align-middle text-center whitespace-nowrap text-sm">
                                    <div class="inline-flex rounded-md shadow-sm" role="group">
                                        <!--[if BLOCK]><![endif]--><?php if($vehicle->trashed()): ?>
                                            <!--[if BLOCK]><![endif]--><?php if($this->canManageVehicle($vehicle)): ?>
                                                <button wire:click="restore(<?php echo e($vehicle->id); ?>)" type="button"
                                                    title="Restaurar"
                                            ...
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <?php else: ?>
                                            <button wire:click="showHistory(<?php echo e($vehicle->id); ?>)" type="button"
                                                title="Histórico" 
                                                class="relative inline-flex items-center px-3 py-1.5 <?php echo e(!$this->canManageVehicle($vehicle) ? 'rounded-md' : 'rounded-l-md'); ?> border border-gray-300 bg-white text-xs font-medium text-blue-600 hover:bg-gray-50 focus:z-10 focus:outline-none focus:ring-1 focus:ring-ifnmg-green focus:border-ifnmg-green transition ease-in-out duration-150">
                                                <svg class="w-4 h-4" fill="none" stroke="currentColor"
                                                    viewBox="0 0 24 24">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($this->canManageVehicle($vehicle)): ?>
                                                <button wire:click="edit(<?php echo e($vehicle->id); ?>)" type="button"
                                                    title="Editar"
                                                ...
                                                <button wire:click="confirmDelete(<?php echo e($vehicle->id); ?>)"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 lg:hidden">
                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $vehicles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $vehicle): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div
                        class="bg-white border rounded-lg p-4 shadow-sm flex flex-col justify-between <?php echo e($vehicle->trashed() ? 'bg-red-50/50 opacity-70' : ''); ?> transition duration-150 ease-in-out">
                        <div>
                            <div class="flex justify-between items-start mb-2">
                                <h3 class="font-semibold text-lg text-gray-800 font-mono">
                                    <?php echo e($vehicle->license_plate); ?></h3>
                                <span
                                    class="px-2.5 py-0.5 inline-flex text-xs leading-5 font-semibold rounded-full <?php echo e($vehicle->type == 'Oficial' ? 'bg-blue-100 text-blue-800 border border-blue-200' : 'bg-green-100 text-green-800 border border-green-200'); ?> ml-2 flex-shrink-0">
                                    <?php echo e($vehicle->type); ?>

                                </span>
                            </div>
                            <p class="text-sm text-gray-600"><?php echo e($vehicle->model); ?> - <?php echo e($vehicle->color); ?></p>
                        ...
                        <div class="mt-4 pt-4 border-t border-gray-100 flex flex-wrap gap-2 justify-end">
                            <!--[if BLOCK]><![endif]--><?php if($vehicle->trashed()): ?>
                                <!--[if BLOCK]><![endif]--><?php if($this->canManageVehicle($vehicle)): ?>
                                    ...
                                    <button wire:click="confirmForceDelete(<?php echo e($vehicle->id); ?>)" type="button"
                            ...
                            <?php else: ?>
                                ...
                                <!--[if BLOCK]><![endif]--><?php if($this->canManageVehicle($vehicle)): ?>
                                    ...
                                    <button wire:click="confirmDelete(<?php echo e($vehicle->id); ?>)" type="button"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'text','id' => 'license_plate_modal','xModel' => 'plate','placeholder' => 'AAA-1234 ou AAA1B23','class' => 'mt-1 block w-full uppercase font-mono text-sm','maxlength' => '8']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','id' => 'license_plate_modal','x-model' => 'plate','placeholder' => 'AAA-1234 ou AAA1B23','class' => 'mt-1 block w-full uppercase font-mono text-sm','maxlength' => '8']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['type' => 'text','id' => 'model','wire:model' => 'model','maxlength' => '25','oninput' => 'this.value = this.value.toUpperCase()','class' => 'mt-1 block w-full text-sm']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','id' => 'model','wire:model' => 'model','maxlength' => '25','oninput' => 'this.value = this.value.toUpperCase()','class' => 'mt-1 block w-full text-sm']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                                ...
                                <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['for' => 'type','class' => 'mt-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['for' => 'type','class' => 'mt-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
    ...
    <!--[if BLOCK]><![endif]--><?php if($isConfirmModalOpen): ?>
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md"
                ...
                <div class="px-6 py-4 bg-gray-50 flex flex-row-reverse space-x-2 space-x-reverse"> <?php if (isset($component)) { $__componentOriginal656e8c5ea4d9a4fa173298297bfe3f11 = $component; } ?>
            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] flex flex-col"
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1 font-medium">
                            <?php echo e($vehicleForHistory->model); ?>

                            <span
                                class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold font-mono bg-gray-200 text-gray-800">
                                <?php echo e($vehicleForHistory->license_plate); ?>

                            </span>
                            <span
                                class="ml-2 inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold <?php echo e($vehicleForHistory->type === 'Oficial' ? 'bg-blue-100 text-blue-800' : 'bg-green-100 text-green-800'); ?>">
                                <?php echo e($vehicleForHistory->type); ?>
                ...
                <div class="p-6 overflow-y-auto bg-gray-50/50 flex-1">
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <p class="text-sm font-bold text-gray-800"><?php echo e($entry->driver_name); ?>
                                        ...
                                        <div
                                            ...
                                            <div class="space-y-3">
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($entry->type === 'Oficial' && $entry->passengers): ?>
                                                    <div>
                                                        <span
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($entry->type === 'Oficial' && $entry->return_observation): ?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($vehicleHistory): ?>
                        <div class="mt-4"><?php echo e($vehicleHistory->links('livewire::simple-tailwind')); ?></div>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                </div>
