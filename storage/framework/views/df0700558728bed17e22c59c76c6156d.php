                ...
                <!--[if BLOCK]><![endif]--><?php if(isset($item['vehicle'])): ?>
                    <tr
                        ...
                        <td class="flex justify-between items-center py-2 sm:py-4 sm:px-6 sm:table-cell border-b sm:border-none">
                            ...
                            <span class="text-right font-medium text-gray-800"><?php echo e($item['vehicle']->model); ?></span>
                        </td>

                        
                        <td class="flex justify-between items-center py-2 sm:py-4 sm:px-6 sm:table-cell border-b sm:border-none">
                            <span class="font-bold text-gray-600 sm:hidden">Placa</span>
                            <span class="text-right font-mono text-gray-600"><?php echo e($item['vehicle']->license_plate); ?></span>
                        </td>
                        ...
                        <td class="flex justify-between items-center py-2 sm:py-4 sm:px-6 sm:table-cell border-b sm:border-none">
                            ...
                            <span class="text-right text-gray-600">
                                <?php echo e(\Carbon\Carbon::parse($item['oldest_trip_date'])->format('d/m/Y H:i')); ?>
                        ...
                        <td
                            ...
                            <span class="text-right font-semibold text-gray-800"><?php echo e($item['count']); ?></span>
                        </td>
