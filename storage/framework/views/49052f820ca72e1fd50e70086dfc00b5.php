<div x-data="{ tab: 'entrada' }">
    ...
    <!--[if BLOCK]><![endif]--><?php if($successMessage): ?>
        <div wire:key="operation-success-<?php echo e($successMessageVersion); ?>"
            x-data="{ show: true }"
            x-show="show"
            ...
            <div class="min-w-0 flex-1">
                ...
                <p class="text-sm mt-1 font-medium"><?php echo e($successMessage); ?></p>
            </div>
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($selectedVehicleInPatio): ?>
                                ...
                                <div class="flex items-start gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="mt-1 text-sm text-amber-800">
                                            Entrada aberta<?php echo e($selectedVehicleOpenEntryAt ? ' desde ' . $selectedVehicleOpenEntryAt : ''); ?>.
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model' => 'new_visitor_name','id' => 'new_visitor_name','class' => 'block mt-1 w-full bg-gray-50 focus:bg-white','type' => 'text']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'new_visitor_name','id' => 'new_visitor_name','class' => 'block mt-1 w-full bg-gray-50 focus:bg-white','type' => 'text']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                            <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['wire:model' => 'new_visitor_document','id' => 'new_visitor_document','class' => 'block mt-1 w-full font-mono bg-gray-50 focus:bg-white','type' => 'tel','xMask' => '999.999.999-99']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'new_visitor_document','id' => 'new_visitor_document','class' => 'block mt-1 w-full font-mono bg-gray-50 focus:bg-white','type' => 'tel','x-mask' => '999.999.999-99']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($driverActionMessage): ?>
                                <div class="mt-4 rounded-lg border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-900 shadow-sm">
                                    <div class="flex items-start gap-2">
                                        ...
                                        <p class="font-semibold"><?php echo e($driverActionMessage); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($selectedVehicleInPatio && $selected_driver_id && !$selectedDriverAlreadyLinked && !$showNewVisitorForm): ?>
                            ...
                            <?php elseif(!$selectedVehicleInPatio && $selectedVehicleId && $selected_driver_id && !$selectedDriverAlreadyLinked && !$showNewVisitorForm): ?>
...
<?php /**PATH C:\Users\Daniel\Documents\Projetos\siga-if\resources\views/livewire/create-private-entry.blade.php ENDPATH**/ ?>