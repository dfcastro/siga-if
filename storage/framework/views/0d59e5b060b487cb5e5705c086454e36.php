...
<body>
    ...
    <?php echo $__env->make('reports.pdf._header', ['title' => 'EXTRATO DE AUDITORIA - FROTA OFICIAL'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        ...
        <table>
            <tr>
                ...
                <td style="width: 34%;"><strong>Condutor Filtrado:</strong>
                    <?php echo e($driver ? $driver->name : 'Todos os servidores autorizados'); ?></td>
            </tr>
        </table>
    </div>
    ...
    <table class="main">
        ...
        <tbody>
            <?php $__empty_1 = true; $__currentLoopData = $trips; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trip): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <tr>
                    <td>
                        <strong><?php echo e($trip->vehicle?->model ?? 'N/A'); ?></strong><br>
                        <span
                            style="color: #4a5568; font-family: monospace;"><?php echo e($trip->vehicle?->license_plate ?? 'N/A'); ?></span>
                    </td>
                    <td>
                        ...
                        <?php if($trip->passengers): ?>
                            <br><span style="color: #4a5568; font-size: 7px;">👤
                                <?php echo e(Str::limit($trip->passengers, 30)); ?></span>
                        <?php endif; ?>
                    </td>
                    <td class="no-break">
                        <?php echo e($trip->departure_datetime?->format('d/m/y H:i')); ?><br>
                        <span style="color: #718096;">KM:
                            <?php echo e(number_format($trip->departure_odometer, 0, ',', '.')); ?></span>
                    </td>
                    <td class="no-break">
                        <?php echo e($trip->arrival_datetime?->format('d/m/y H:i') ?? 'Em viagem'); ?><br>
                        <span style="color: #718096;">KM:
                            <?php echo e($trip->arrival_odometer ? number_format($trip->arrival_odometer, 0, ',', '.') : '-'); ?></span>
                    </td>
                    ...
                    <td style="font-weight: bold;">
                        <?php echo e($trip->distance_traveled ? $trip->distance_traveled . ' km' : '-'); ?></td>
                </tr>
                <?php if($trip->return_observation): ?>
                    <tr class="observation-row">
                        <td colspan="8">
                            <strong>Observação no Retorno:</strong> <?php echo e($trip->return_observation); ?>
            ...
            <tfoot class="total-row">
                <tr>
                    <td colspan="7" style="text-align: right; border-right: none;">Total de viagens listadas:
                        <?php echo e($trips->count()); ?> | <strong>Quilometragem Total do Período:</strong></td>
                    <td style="text-align: center; border-left: none;"><?php echo e(number_format($totalKm, 0, ',', '.')); ?> km
                    </td>
                </tr>
            </tfoot>
        <?php endif; ?>
